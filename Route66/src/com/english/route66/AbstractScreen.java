...
public abstract class AbstractScreen implements Screen {
	...
	public AbstractScreen(Route66 game, Texture background) {
		this.game = game;
	...
	@Override
	public void show() {
		Gdx.app.log(Route66.LOG, "Showing screen: " + getName());
	...
	public void resize(int width, int height) {
		Gdx.app.log(Route66.LOG, "Resizing screen: " + getName() + " to: "
				+ width + " x " + height);
	}
	...
	public void render(float delta) {
		...
		getBatch().begin();
		getBatch().draw(background, 0, 0, stage.getWidth(), stage.getHeight());
		getBatch().end();
		// draw the actors
		stage.draw();
	...
	@Override
	public void hide() {
		Gdx.app.log(Route66.LOG, "Hiding screen: " + getName());
	...
	@Override
	public void pause() {
		Gdx.app.log(Route66.LOG, "Pausing screen: " + getName());
	}

	@Override
	public void resume() {
		Gdx.app.log(Route66.LOG, "Resuming screen: " + getName());
	}

	@Override
	public void dispose() {
		Gdx.app.log(Route66.LOG, "Disposing screen: " + getName());
